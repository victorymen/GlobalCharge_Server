...
public class JsapiServiceExample {
    /**AppId*/
    public static String AppId = "wx316be3df54cf177d";
    /** 商户号 */
    public static String merchantId = "1708773892";

    /** 商户API私钥路径 */
    public static String privateKeyPath = "E:\\Chargelink\\AppServer\\1708773892_20250305_cert\\apiclient_key.pem";

    /** 商户证书序列号 */
    public static String merchantSerialNumber = "69FEA7BE7F4CE1A8A984B0B2BA919BAC5272FEAA";

    /** 商户APIV3密钥 */
    public static String apiV3Key = "69FEA7BE7F4CE1A8A984B0B2BA919BAC";
    ...
    public static PrepayWithRequestPaymentResponse prepayWithRequestPayment() {
        ...
        request.setDescription("摩洛哥-话费充值-测试");
        request.setOutTradeNo("202108171015590000001");
